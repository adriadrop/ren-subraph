...
export class Ren extends ethereum.SmartContract {
  static bind(address: Address): Ren {
    return new Ren("Ren", address);
  }
  ...
  transferTokens(beneficiary: Address, amount: BigInt): boolean {
    let result = super.call(
      "transferTokens",
      "transferTokens(address,uint256):(bool)",
      [
